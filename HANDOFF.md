...
| `deskband/ui.py` | ~200 | 绘图原语：双色调底图、保留彩色区域、细线圆角框、SF Pro 文字、毛玻璃卡片 |
...
- BTN0 始终启停并拍照/重拍。SW3=0 是 mixer：SW2:0 选轨，BTN1 下一拍 mute、BTN2 硬件 fade、BTN3 LFO。SW3=1 是 performance：BTN1 下一小节 lock/unlock 该轨生成结果、BTN2 下一小节切换 sparse/normal/full、BTN3 排队一个 full-density fill bar；fill 后自动生成继续。运行时 LED 显示十六步位置。
